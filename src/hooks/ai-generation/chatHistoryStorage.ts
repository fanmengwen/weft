...
function toAssistantThreadItems(messages: PersistedChatMessage[]): AssistantThreadItem[] {
  return messages.map((message) => ({
    ...
    copyKey: message.copyKey as AssistantThreadItem['copyKey'],
    previewDetailKey: message.previewDetailKey as AssistantThreadItem['previewDetailKey'],
...
function toPersistedThreadItems(
  ...
  return items.map((item, index) => ({
    ...
    previewDetailKey: item.previewDetailKey,
